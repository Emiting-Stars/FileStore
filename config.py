...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7412999973:AAHWB3Uze1zB4p9XyeuAO24gaQ-uJbJkNXw")
...
# NAMA OWNER
OWNER = os.environ.get("OWNER", "RexySama")
#OWNER ID
...
DB_NAME = os.environ.get("DATABASE_NAME", "WeekendsMovie1")
...
FORCE_SUB_CHANNEL1 = int(os.environ.get("FORCE_SUB_CHANNEL1", "-1002006075403"))
#put 0 to disable
